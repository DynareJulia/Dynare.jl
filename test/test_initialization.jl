...
let first_obs, last_obs, first_simulation_period, last_simulation_period, nobs, period_type
    options = Dict("first_obs" => "1979Y",
                   "last_obs" => "2000Y",
                   "first_simulation_period" => "1980Y",
                   "last_simulation_period" => "1999Y",
                   "nobs" => "22")
    (first_obs, last_obs, first_simulation_period, last_simulation_period, nobs, period_type) =
    ...
    @test_throws AssertionError (first_obs1, last_obs1, first_simulation_period1, last_simulation_period1, period_type1) =
        Dynare.check_periods_options(options, required_lags=1, required_leads=1)
end
