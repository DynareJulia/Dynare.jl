...
estimation(datafile='dsge1_data.csv', mh_replic=100000, mh_jscale=0.2);
//mode_compute!(datafile="dsge1_data.csv", display=true, transformed_parameters = true);
//first_chain = rwmh_compute!(datafile="dsge1_data.csv", mcmc_replic=100000, mcmc_jscale=0.03, mcmc_chains=1, transformed_parameters = true);
