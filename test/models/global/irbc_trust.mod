///////
// TO BE RUN WITH context = @dynare "irbc" "-DN=<nbr of countries>";
///////
///////
// IRBC model from
...
(grid, state_variables, policy_variables) = sparsegridapproximation(scaleCorrExclude=["lambda"], method=TrustRegion());
