///////
// TO BE RUN WITH context = @dynare "irbc_irr" "-DN=<nbr of countries>";
///////
// IRBC model from
...
(grid, state_variables, policy_variables) = sparsegridapproximation(scaleCorrExclude=["lambda"], solver=PATHSolver, mcp = true);
