...
my_chains = mh_estimation(context, datafile = "test/models/ls2003/data_ca1.csv", first_obs=8, last_obs=86, iterations = 10000, initial_values=res[2], covariance=res[4])
...
f = mcmc_diagnostics(Dynare.my_chains, context, ["psi1"])
display(f)
